...
$scene_shift_current_user_id = function_exists( 'get_current_user_id' ) ? (int) get_current_user_id() : 0;
if ( $scene_shift_current_user_id > 0 ) {
	delete_transient( 'scene_shift_notice_' . $scene_shift_current_user_id );
}
